...
se divide  físicamente en conjuntos de entrenamiento (80%) y prueba (20%) quedan en 'data/processed/'.
...
def main():
    ...
    # 8 Clases de destino las que viene en el proyecto
    target_classes = [
...
## Fin del procesado de datos para el apartado de CNN -- Dani a partir de este punto puede colocar el adaptado del otro procesamiento o aparte
